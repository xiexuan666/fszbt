...
layui.define(['element', 'carousel', 'table', 'util'], function(exports){
  ...
  $(".house-header").find("#search").on('click', function(){
    layer.open({
      ...
      ,shadeClose: true
      ,area: '300px'
      ,content: '<div id="house-search" class="layui-form"><input type="text" placeholder="智能搜索" class="layui-input"></div>'
  ...
  table.render({
    elem: '#user-address'
    ,url:  '/public/home/layui/json/address.json'
    ,skin: 'line'
    ,cols: [[
  ...
  table.render({
    ...
    ,url:  '/public/home/layui/json/order.json'
    ,skin: 'line'
    ,cols: [[
  ...
  table.render({
    ...
    ,url:  '/public/home/layui/json/shop.json'
    ,skin: 'line'
    ,cols: [[
