...
$(function(){
	$.ajax({
	type: "POST",
	url: "http://shop.fszbt.com/index.php/admin/server.upgrade_api/updatewebinfo",
	data: {host:'<?php echo $host;?>',https:'<?php echo 'http://'.$host;?>',version:'FSZBT-DT v1.0.0',ip:'<?php echo $_SERVER[HTTP_CLIENT_IP];?>'},
	dataType: 'json',
	success: function(){}
	});
});
