        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <ul  class="folder-list m-b-md">
                    ...
                    <li class="p-xxs"><a href="{:Url('answer.answer/index',array('pid'=>$vo.id))}">{$vo.level|str_repeat='.....',###}{$vo.title}</a></li>
                    {/volist}
                </ul>
            </div>
        </div>
    ...
    <div class="col-sm-9 m-l-n-md">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('add',array('cid'=>$where.cid))}',{w:1100,h:760})">添加</button>
