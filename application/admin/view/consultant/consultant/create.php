...
<div class="row" style="width: 100%">
    <div class="col-sm-12">
        <div class="col-sm-2 panel panel-default news-left">
            <div class="panel-heading">知识列表</div>
            ...
            <div class="col-sm-12 panel panel-default" >
                <div class="panel-heading">知识内容编辑</div>
                <div class="panel-body">
                    <form class="form-horizontal" id="signupForm">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="input-group">
                                    <span class="input-group-addon">知识分类</span>
                                    <?php if(empty($all)){?>
                                    <select data-placeholder="请先添加知识分类" class="chosen-select"  style="width:100%;" tabindex="4" name="type_id">
                                        <?php }else{ ?>
                                            <select data-placeholder="选择知识分类" class="chosen-select"  style="width:100%;" tabindex="4" name="type_id" {eq name="$select" value="1"}disabled="disabled"{/eq}>
                                        <?php }?>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label style="color:#aaa">知识简介</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label style="color:#aaa">知识内容</label>
