        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <ul  class="folder-list m-b-md">
                    ...
                    <li class="p-xxs"><a href="{:Url('consultant.consultant/index',array('pid'=>$vo.id))}">{$vo.level|str_repeat='.....',###}{$vo.title}</a></li>
                    {/volist}
                </ul>
            </div>
        </div>
    ...
    <div class="col-sm-9 m-l-n-md">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('add',array('cid'=>$where.cid))}',{w:1100,h:760})">添加提问</button>
                ...
                <table class="footable table table-striped  table-bordered " data-page-size="20">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑','{:Url('edit',array('id'=>$vo['id'],'cid'=>$where.cid))}',{w:800,h:600})"><i class="fa fa-paste"></i> 编辑</button>

                            <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑内容','{:Url('edit_content',array('id'=>$vo['id'],'cid'=>$where.cid))}',{w:800,h:600})"><i class="fa fa-paste"></i> 编辑内容</button>
