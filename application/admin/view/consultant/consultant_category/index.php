    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary add-filed">添加提问分类</button>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{:Url('consultant.consultant/index',array('cid'=>$vo['id']))}" style="color: #666;display: block;padding: 5px 0;">查看提问</a>
                            </td>
                            <td class="text-center">
