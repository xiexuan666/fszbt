...
<script>
    ...
    layList.tableList('List',"{:Url('getList',['pid'=>$pid])}",function (){
        return [
            ...
            {field: 'title', title: '分类名称',event:'title',edit:'title'},
            {field: 'pid', title: '查看子分类',width:'8%',templet:'#pid',align:'center'},
            {field: 'image', title: '分类图标',templet:'#image',width:'8%',align:'center'},
    ...
    var action= {
        set_category: function (field, id, value) {
            layList.baseGet(layList.Url({
                c: 'knowledge.knowledge_category',
                a: 'set_category',
    ...
    layList.switch('status',function (odj,value) {
        if(odj.elem.checked==true){
            layList.baseGet(layList.Url({c:'knowledge.knowledge_category',a:'set_show',p:{status:1,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }else{
            layList.baseGet(layList.Url({c:'knowledge.knowledge_category',a:'set_show',p:{status:0,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }
    });
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'knowledge.knowledge_category',a:'delete',q:{id:data.id}});
