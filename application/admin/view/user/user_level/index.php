            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="icon">
                        <img style="cursor: pointer; height: 30px; width: 30px;" lay-event='open_image' src="{{d.icon}}">
                    </script>
...
<script>
    ...
    layList.tableList('List',"{:Url('get_system_vip_list')}",function (){
        return [
            {field: 'id', title: '编号', sort: true,event:'id',width:'8%'},
            {field: 'icon', title: '等级图标',templet:'#icon',width:'8%'},
            ...
            {field: 'is_forever', title: '是否永久',templet:'#is_forever'},
            {field: 'is_pay', title: '是否付费',templet:'#is_pay'},
