    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary add-filed">添加职位分类</button>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{:Url('job.job/index',array('cid'=>$vo['id']))}" style="color: #666;display: block;padding: 5px 0;">查看职位</a>
                            </td>
                            <td class="text-center">
