    ...
    <i-Form :label-width="80" style="width: 100%" v-show="hidden == true">
        <Form-Item
            ...
            <Row>
                <i-Col style="position: relative;margin-right: 6px"  span="5"
                       ...
                       :key="index">
                    <i-Input type="text" v-model="item.value" placeholder="设置标题"></i-Input>
        ...
        <Form-Item v-show="item.attrHidden == true"
            ...
            <Row>
                ...
                <i-Col span="5">
                    <i-Button type="primary" style="margin-left: 6px" @click="attrAdd(item)">确认插入</i-Button>
                </i-Col>
            </Row>
        </Form-Item>
        <Form-Item v-show="hidden == true" style="width: 100%;">
            <Row style="margin: 0 88px 0 20px">
                <i-Col span="24">
                    <i-Button type="primary" long @click="addGoods(true)">生成套餐设置列表</i-Button>
                </i-Col>
            </Row>
        </Form-Item>
            ...
            <template v-for="(attr,index) in attrs">
                <Form-Item>
                    <Row>
                        ...
                        <i-Col span="4">
                            <span :class="attr.check ? 'check':''">人数起:</span>&nbsp;&nbsp;<i-Input placeholder="人数起" v-model="attr.since" style="width: 60%"
                                                                                                   :number="true"></i-Input>
                        </i-Col>
                        <i-Col span="4">
                            <span :class="attr.check ? 'check':''">人数止:</span>&nbsp;&nbsp;<i-Input placeholder="人数止" v-model="attr.sales" style="width: 60%"
                                                                                                  :number="true"></i-Input>
                        </i-Col>

                        <i-Col span="4">
                            <span :class="attr.check ? 'check':''">单价:</span>&nbsp;&nbsp;<i-Input placeholder="金额" v-model="attr.price" style="width: 60%"
                                     :number="true"></i-Input>
                        </i-Col>
            ...
            <Form-Item>
                <Row>
                    ...
                    <i-Col span="2" offset="1">
                        <i-Button type="error" @click="clear">清空所有套餐</i-Button>
                    </i-Col>
                </Row>
            </Form-Item>
        </template>
