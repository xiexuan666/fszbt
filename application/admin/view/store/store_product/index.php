            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="store_name">
                        ...
                        <p>积分:<font color="red">{{d.give_integral}}</font> </p>
                        <p>访客量:{{d.visitor}}</p>
                        <p>浏览量:{{d.browse}}</p>
                    </script>
                    <!--操作-->
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <!--<li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame(this.innerText,'{:Url('ump.store_raise/raise')}?id={{d.id}}')"">
                                <i class="fa fa-users"></i> 开启众筹</a>
                            </li>
                            <li>
        ...
        switch (parseInt(type)){
            case 1:case 3:case 4:case 5:
                join=[
                    ...
                    {field: 'cate_name', title: '商品归类',event:'cate_name'},
