            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}',{h:700,w:1100})">添加秒杀</button>
                    </div>
...
<script>
    ...
    layList.tableList('seckillList',"{:Url('get_seckill_list')}",function () {
        return [
            ...
            {field: 'status', title: '状态',width:'8%',toolbar:"#status"},
