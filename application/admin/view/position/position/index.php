                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="name" class="layui-input" placeholder="请输入关键词">
                                </div>
                            </div>
                            <div class="layui-inline">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        <a class="layui-btn layui-btn-sm" href="{:Url('index')}">职位首页</a>
                        <button type="button" class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">添加职位</button>
                    </div>
...
<script>
    ...
    layList.tableList('List',"{:Url('getList',['pid'=>$pid])}",function (){
        return [
            ...
            {field: 'name', title: '职位',edit:'name'},
            {field: 'pid', title: '查看子职位',width:'8%',templet:'#pid',align:'center'},
    ...
    layList.switch('status',function (odj,value) {
        if(odj.elem.checked==true){
            layList.baseGet(layList.Url({c:'position.position',a:'set_show',p:{status:1,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }else{
            layList.baseGet(layList.Url({c:'position.position',a:'set_show',p:{status:0,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }
    });
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'position.position',a:'delete',q:{id:data.id}});
