...
class NewProductAttr extends ModelBasic
{
    use ModelTrait;
    ...
    public static function createProductAttr($attrList,$valueList,$productId)
    {
        ...
        $attrModel = new self;
        $attrValueModel = new NewProductAttrValue;
        self::beginTrans();
        ...
        && false !== NewProductAttrResult::setResult($result,$productId);
        self::checkTrans($res);
        if($res)
            return true;
        else
    ...
    public static function clearProductAttr($productId)
    {
        ...
        $res = false !== self::where('product_id',$productId)->delete()
            && false !== NewProductAttrValue::clearProductAttrValue($productId);
        if(!$res)
