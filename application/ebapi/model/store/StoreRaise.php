...
class StoreRaise extends ModelBasic
{
    ...
    {
        $res = false !== self::where('id',$RaiseId)->dec('stock',$num)->inc('sales',$num)->inc('people',1)->update();
        return $res;
    }
     ...
     * @return bool
     */
    public static function incRaiseStock($num,$RaiseId)
    {
        $res = false !== self::where('id',$RaiseId)->inc('stock',$num)->dec('sales',$num)->update();
        return $res;
    }
