...
namespace app\ebapi\model\talent;

use think\Db;
use traits\ModelTrait;
use basic\ModelBasic;

class Talent extends ModelBasic
{
    use ModelTrait;
     ...
     * @return mixed
     */
    public static function getTalentList($field = 'id,uid,cid,title,name,author,phone,address,region,experience,education,salary,welfare,tag,scale,image,slider_image,synopsis,is_show,is_top,is_new,is_hot,sort,visit,ficti,description,province,city,district,is_default'){
        $model = new self();
    ...
    public static function setDefaultTalten($id,$uid)
    {
        self::beginTrans();
