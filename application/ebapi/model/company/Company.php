...
namespace app\ebapi\model\company;
...
class Company extends ModelBasic
{
     ...
     * @return mixed
     */
    public static function getCompanyListHot($field = 'id,title,synopsis,author,image,visit,add_time',$limit = 0){
        $model = new self();
     ...
     */
    public static function getCompanyLoading($field = '*',$offset = 0,$limit = 0)
    {
    ...
    public static function getCompanyList($data,$uid)
    {
        $cId = $data['cid'];
